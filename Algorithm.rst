...
Для получения информации о сжатых данных необходимо воспользоваться программой `compsize<https://github.com/kilobyte/compsize>`, поскольку есть вероятность того, что системные средства не смогут определить наличие сжатия и будут отображать "необходимое" место вместо используемого на носителе.
